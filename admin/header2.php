...
<body>
	...
	<div class="col-md-2">
		...
		<ul class="nav nav-pills nav-stacked">
			...
			<li><a href="barang_laku2.php"><span class="glyphicon glyphicon-briefcase"></span>  Order</a></li>        												
			<li><a href="ganti_foto2.php"><span class="glyphicon glyphicon-picture"></span>  Ganti Foto</a></li>
			<li><a href="ganti_pass2.php"><span class="glyphicon glyphicon-lock"></span> Ganti Password</a></li>
